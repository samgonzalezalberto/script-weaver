...
* Cached tasks must restore artifacts exactly as produced originally (copying them from cache to workspace if missing or different)sks in the final GraphResult
...
* Failure propagration rules from Sprint-01 apply unchanged
